<?php 
$this->registerJs('
        var controller_id = "custom-content";
...
/* @var $searchModel backend\models\CustomContentSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Custom Contents';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="custom-content-index">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="pull-right">
                        <a id="modalButton" value="<?= Url::toRoute(['custom-content/create']) ?>" class="btn btn-success btn-icon-split">
