...
/* @var $searchModel backend\models\FoodTypeSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Food Types';
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="pull-right">
                        <a id="modalButton" value="<?= Url::toRoute(['food-type/create']) ?>" class="btn btn-success btn-icon-split">
