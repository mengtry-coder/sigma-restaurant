<?php 
$this->registerJs('
        var controller_id = "custom-field";
...
/* @var $searchModel backend\models\CustomFieldSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Custom Fields';
$this->params['breadcrumbs'][] = ['label' => 'Custom Field', 'url' => ['index']];
?>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="pull-right">
                        <a id="modalButton" value="<?= Url::toRoute(['custom-field/create']) ?>" class="btn btn-success btn-icon-split">
